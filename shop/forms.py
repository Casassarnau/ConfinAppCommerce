...
class ShopFormView(ModelForm):
    # TODO: Obtain latitude and longitude from the street in google maps.
    CIF = ESIdentityCardNumberField(only_nif=False, label='CIF', widget=forms.TextInput(attrs={'placeholder': 'CIF'}))

    meanTime = RangeSliderField(label='Mean Time', minimum=0, maximum=60,  step=5, name="How many time does the user stay in your shop while shopping?" )
