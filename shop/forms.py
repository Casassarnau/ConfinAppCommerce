...
class ShopForm(forms.ModelForm):
    ...
    secondaryCategories = SelectCategoryField(queryset=models.SecondaryCategory.objects.all(),
                                              placeholder='Busca una categoria ...', is_loading=False,
    ...
    map = LocationField(label='Mapa', map_attrs={"center": [2.1589899, 41.3887901], "marker_color": "#ba6b6c",
                                                 'zoom': 10, 'placeholder': 'Tria una localització a sota'})
