...
urlpatterns = [
    ...
    url(r'^shop_admins/(?P<id>[0-9A-Za-z_\-]+)/delete/(?P<idA>[0-9A-Za-z_\-]+)$', views.delete_admin,
        name='delete_shop_admins'),
    ...
    url(r'^schedules/(?P<id>[0-9A-Za-z_\-]+)/delete/(?P<idS>[0-9A-Za-z_\-]+)$', views.delete_schedule,
        name='del_schedule'),
]
